...
{
    public static class SnkrsMonitorDbContextModelCreatingExtensions
    {
        public static void Configure(this ModelBuilder builder)
        {
            //Check.NotNull(builder, nameof(builder));

            builder.Entity<SnkrsMonitor.Product.Product>(b =>
            {
                b.ToTable(SnkrsMonitorConsts.DbTablePrefix + DbTableName.Product);
                b.HasKey(x => x.Id);
                b.Property(x => x.Name).HasMaxLength(200).IsRequired();
                b.Property(x => x.No).HasMaxLength(10);
                b.Property(x => x.Code).HasMaxLength(100).IsRequired();
                b.Property(x => x.IndexPicUrl).HasMaxLength(1000).IsRequired();
